...
% Mafalda
if (nauseas and vomitos and diarreia) and (febre or dores_musculares or dor_cabeca or colicas) then gastroenterite:0.8.
if (dor_urinar and vontade_urinar) and (urina_turva or sangue_urina) then infecao_urinaria:0.9.
if (dor_cabeca) and (sensibilidade_luz or sensibilidade_som or nauseas) then enxaqueca:0.8.
...
% Diana
if tosse and (febre or fadiga or dor_peito or suar_excessivamente) then tuberculose:0.9.
if (dor_cabeca and zumbido_ouvido) and (dificuldade_respirar or nauseas or vomitos or dor_peito) then hipertensao:0.8.
if (sede_excessiva and vontade_urinar) and (fadiga or fome_excessiva) then diabetes:0.8.
...
if (tosse and febre and dificuldade_respirar) and (fadiga or nauseas or vomitos or dor_peito or confusao_mental) then pneumonia:0.8.

% Zé
if (congestao_nasal) and (tosse or fadiga or perda_paladar or perda_olfato) then rinite:0.7.
if dores_musculares then lombalgia:0.6.
if (dor_cabeca and tosse) and (febre or fadiga or dores_musculares) then sinusite:0.7.
if (nauseas or vomitos) and (febre or fadiga or dores_musculares) then hepatite:0.8.
if (febre and calafrios) and (dor_garganta or dores_musculares or fadiga) then malaria:0.6.

% Vitória
if (febre and dor_cabeca) and (nauseas or vomitos or calafrios or zumbido_ouvido or dor_ouvidos) then laringite:0.7.
if sensibilidade_luz or comichao_olhos then otite:0.9.
if (febre and fadiga) and (dores_musculares or dor_cabeca or calafrios or comichao_pele) then conjuntivite:0.8.
if (tosse and febre and dificuldade_respirar) and (fadiga or dor_cabeca or perda_paladar or dor_garganta or calafrios or dor_ouvidos) then varicela:0.9.
if (tosse and febre and dificuldade_respirar) and (fadiga or dor_garganta) then amigdalite:0.8.
